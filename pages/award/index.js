        ...
        <>
            ...
            <main className="ms-main">
                <div className="ms-page-content">
                    ...
                    <div className='aboutsection bg-black'>
                        <div className='container py-24'>
                        ...
                        <div className='container '>
                            <div className='row '>
                                <div className='col-lg-6 h-auto'>
                                    <img src='/images/about/spoorthi2.webp' alt='' />
                                </div>
                    ...
                    <div className="banner-area inner teams1">
                        <div className="container ">
                            ...
                            <div className='font golden animated bounceIn text-center text-xl font-semibold' id="animated-example">
                                Events may be forgotten,But an
                            </div>
                            <div className=' text-center font text-7xl text-white uppercase font-semibold pt-3 bounceInRight animated' id="animated-example">
                                experience will
                            </div>
